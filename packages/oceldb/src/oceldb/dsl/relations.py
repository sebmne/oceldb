...
def related(object_type: str) -> RelationBuilder:
    """
    Build a predicate over objects related through shared events.

    Valid only in object-rooted scope.
    """
...
def linked(object_type: str) -> RelationBuilder:
    """
    Build a predicate over objects linked through object-object relations.
...
def has_event(event_type: str) -> RelationBuilder:
    """
    Build a predicate over events attached to the current object.
